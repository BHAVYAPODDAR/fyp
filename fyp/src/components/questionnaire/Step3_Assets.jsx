...
// const Step3_AssetsInfo = ({ formData, updateFormData, errors, setErrors }) => {
//   const [assets, setAssets] = useState(formData.assets || []);

//   const handleAddAsset = () => {
//     setAssets((prev) => [...prev, { type: "", description: "", value: "" }]);
//   };
...
//               label="Description"
//               fullWidth
//               placeholder="e.g., Flat in Andheri, Demat Account at Zerodha"
...
// // Optional static validation method
// Step3_AssetsInfo.validate = async () => {
//   // Basic check: at least one asset with all fields filled
